...
public class GenerateResponse {
  ...
  public static class ResponseData {
    ...
    public List<CopyItem> getItems() {
      return items;
    }

    public void setItems(List<CopyItem> items) {
      this.items = items;
    }

    public Integer getTotalSensitiveCount() {
      return totalSensitiveCount;
    }

    public void setTotalSensitiveCount(Integer totalSensitiveCount) {
  ...
  public static class CopyItem {
    ...
    public void setSensitiveWords(List<SensitiveWord> sensitiveWords) {
